    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.fileUploadContainer}>
          ...
          <Text style={styles.uploadText}>Upload a PDF, PPT, or text file and we'll convert it to flashcards.</Text>
      ...
      <View style={styles.section}>
        ...
        <TextInput style={styles.input} placeholder="e.g. Algebra Fundamentals" value={title} onChangeText={setTitle} />
        ...
        <TouchableOpacity style={styles.selectInput}>
          <Text style={styles.selectText}>{category || "Select Category"}</Text>
        ...
        <View style={styles.cardCountContainer}>
          {[5, 10, 15, 20, 25].map((count) => (
            <TouchableOpacity
              key={count}
              style={[styles.cardCountButton, cardCount === count && styles.cardCountButtonActive]}
