// components/GenerateWithPromptScreen.tsx
...
interface GenerateWithPromptScreenProps {
  onBack: () => void;
  onClose: () => void;
}

const GeneratePrompt: React.FC<GenerateWithPromptScreenProps> = ({ onBack, onClose }) => {
